...
export default function TenderStatsChart({
  ...
  const { processedData, isProcessing, refreshData, statistics } =
      ...
      {hasWinningTenders ? (
        <>
          <div className="mb-4 flex items-center justify-between">
            <div className="space-y-1">
              <h3 className="flex items-center text-xl font-medium leading-6 text-gray-900">
                ...
                {timeUnit === 'year' ? '歷年' : '近三年'}得標案件
                {timeUnit === 'year' ? '年統計' : '月統計'}
              </h3>
              {isLoadingMore && (
                <motion.div
                ...
                >
                  ...
                  <motion.div
                    className="ml-2 h-1.5 w-24 overflow-hidden rounded-full bg-gray-200"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                  >
                    <motion.div
            ...
            <div className="flex items-center space-x-4">
              <div className="inline-flex rounded-lg shadow-sm">
                <button
                  ...
                  className={`rounded-l-lg px-4 py-2 text-sm font-medium transition-all duration-200 ${
                    timeUnit === 'month'
          ...
          <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-3">
            <motion.div
              className="rounded-lg border border-green-100 bg-gradient-to-br from-green-50 to-emerald-50 p-4"
            ...
            <motion.div
              className="rounded-lg border border-blue-100 bg-gradient-to-br from-blue-50 to-sky-50 p-4"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              className="rounded-lg border border-amber-100 bg-gradient-to-br from-amber-50 to-yellow-50 p-4"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
