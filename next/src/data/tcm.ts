...
export const questions: Question[] = [
  ...
  {
    id: 'q16',
    text: '您是否經常感到焦慮或緊張？（0 分代表從不焦慮，4 分代表經常焦慮）',
    constitutions: {
      'qi-stagnation': 3,
      'yin-deficiency': 1, // 陰虛也可能導致焦慮
    },
  },
  // 特稟質相關問題
  {
    id: 'q17',
    text: '您是否對某些食物、氣味或環境特別敏感，容易過敏？（0 分代表從不過敏，4 分代表經常過敏）',
    constitutions: {
      special: 4, // 特稟質顯著相關
    },
  },
  {
    id: 'q18',
    text: '您是否經常打噴嚏、流鼻涕或鼻塞？（0 分代表從不，4 分代表經常）',
    constitutions: {
      special: 3,
      'qi-deficiency': 1, // 氣虛也可能導致免疫力下降
    },
  },
  // 綜合問題，微調平衡
  {
    id: 'q19',
    text: '您的睡眠質量如何？（0 分代表很差，4 分代表很好）',
    constitutions: {
      balanced: 2,
      'yin-deficiency': -2,
      'qi-stagnation': -1,
  ...
  {
    id: 'q20',
    text: '您的情緒是否穩定，很少感到焦慮或煩躁？（0 分代表很不穩定，4 分代表很穩定）',
    constitutions: {
      balanced: 2,
      'qi-stagnation': -2,
      'yin-deficiency': -1,
